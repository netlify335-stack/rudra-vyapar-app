...
export default function InventoryClient({ storeId }: { storeId: string }) {
  ...
  if (error || !data) return <div>Error loading inventory</div>;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <InventorySettingsButtons storeId={storeId} />
      </div>
      ...
      <Section title="All products">
        <ProductList initialList={list} storeId={storeId} />
      </Section>
    </div>
  );
}
